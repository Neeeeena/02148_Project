  ...
  <div class="row-fluid">
        <div class="span3">
            ...
            <figure>
                ...
                <button type="button" class="btn btn-default btn-md" data-toggle="modal" data-target="#modalTradeOffer">Send Trade Offer</button>
      <!--Sidebar content-->
                <br />
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Repeater runat="server" ID="tradeOfferRepeater" OnItemDataBound="TradeOfferRepeater_ItemDataBound">
                            <ItemTemplate>
                                ...
                                <h2>Receiving:</h2>
                                <asp:Repeater runat="server" ID="tradeSellerResources">
                                    <ItemTemplate>
                                ...
                                <h2>Sending:</h2>
                                <asp:Repeater runat="server" ID="tradeReceiverResources">
                                    <ItemTemplate>
                                        <h3><%#Eval("Key") %>: <%#Eval("Value") %></h3>
                                    </ItemTemplate>
                                </asp:Repeater>
	  ...
	  <h2>CHAT</h2>
                    <ul class="nav nav-tabs">
                        <li id="chat1" style="width: 25%"><a data-toggle="tab" href="#all">
                            <p>Everyone</p>
                        </a></li>
                        <li id="chat2" style="width: 25%"><a data-toggle="tab" href="#p1">
                            <p id="player1Tab" runat="server"></p>
                        </a></li>
                        <li id="chat3" style="width: 25%"><a data-toggle="tab" href="#p2">
                            <p id="player2Tab" runat="server"></p>
                        </a></li>
                        <li id="chat4" style="width: 25%"><a data-toggle="tab" href="#p3">
                            <p id="player3Tab" runat="server"></p>
                        </a></li>
	  </ul>
